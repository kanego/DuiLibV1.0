...
private:
	//DIB:Device Independent Bitmap：：DIB的颜色模式与设备无关。
	//例如，一个256色的DIB即可以在真彩色显示模式下使用，也可以在16色模式下使用。256色以下（包括256色）的DIB拥有自己的颜色表，像素的颜色独立于系统调色板。
    ...
    bool m_bFocusNeeded;
    bool m_bOffscreenPaint;//是否为双缓冲绘制模式
    bool m_bAlphaBackground;//是否为透明背景
    ...
    //
    CPaintManagerUI* m_pParentResourcePM;  //父绘制管理者
    DWORD m_dwDefaultDisabledColor;			//默认非可用状态字体颜色
